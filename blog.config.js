...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Leon', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '后端程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://iamleon.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, PHP, 后端, 程序员, openAI', // 网站关键词 英文逗号隔开
